    ...
    <section>
      <div class="content-body">
          ...
          ?>
            <div class="q-row">
              <div class="left-section">
                <div>
                  <span>Question:</span> <span id="question1"><?php echo $question['q_title']; ?></span>
                </div>
                <div>
                  <span>Answer Type:</span> <span id="answer-type1"><?php echo $question['ans_type']; ?></span>
                </div>
                <div>
                  <span>Points:</span> <span id="points1"><?php echo $question['points']; ?></span>
                </div>
              </div>
        ...
        <div class="q-row">
          <div class="left-section">
            <div>
              <span>Question:</span> <span id="question2">Why should we hire you?</span>
            </div>
            <div>
              <span>Answer Type:</span> <span id="answer-type2">Multiple Choice</span>
            </div>
            <div>
              <span>Points:</span> <span id="points2">["32", "500"]</span>
            </div>
          </div>
          <div class="right-section">
            <button class="edit-button" id="save-button" onclick="openEditOverlay(2); return false;">Edit</button>
          </div>
        </div>
        ...
        <div class="q-row">
          <div class="left-section">
            <div>
              <span>Question:</span> <span id="question3">Are you a determined worker</span>
            </div>
            <div>
              <span>Answer Type:</span> <span id="answer-type3">Multiple Choice</span>
            </div>
            <div>
              <span>Points:</span> <span id="points3">["45", "500"]</span>
            </div>
          </div>
          <div class="right-section">
            <button class="edit-button" id="save-button" onclick="openEditOverlay(3); return false;">Edit</button>
          </div>
        </div>
        ...
        <div class="q-row">
          <div class="left-section">
            <div>
              <span>Question:</span> <span id="question4">How can I help you?</span>
            </div>
            <div>
              <span>Answer Type:</span> <span id="answer-type4">Multiple Choice</span>
            </div>
            <div>
              <span>Points:</span> <span id="points4">["32", "500"]</span>
            </div>
          </div>
          <div class="right-section">
            <button class="edit-button" id="save-button" onclick="openEditOverlay(4); return false;">Edit</button>
          </div>
        </div>
                  ...
                  <?php if ($questionList > 0) : ?>
                    ...
                    ?>
                      <label for="option1">
                        ...
                        <input type="checkbox" id="option1" name="SelectedQuestions[]" value="<?php echo $question['id']; ?>">
                        <!--<li class="form-control"><//?php $question['q_title']; ?></li>
                      </label>
    ...
    if (count($questionSet) > 0) : ?>
      ...
      <div id="hori">
        <h2>Created Question Sets</h2>
          ...
          <?php 
          if ($MainCharacter == "") {
            $MainCharacter = $question['setTitle'];
          }
          $SideCharacter = $question['setTitle']; 
          if ($MainCharacter == $SideCharacter) {
            $counter++;
          }
          if ($MainCharacter != $SideCharacter) :?>
          <div class="q-row">
          <div class="left-section">
            ...
            <span>Question Set:</span> <span><?php echo $question['setTitle']; ?></span>
            <span>Questions Counted:</span> <span><?php echo $counter; ?></span>
            </div>
      </div>
          <?php 
          $counter = 1;
          $MainCharacter = $SideCharacter;
        endif; ?>
